# Generated by Django 5.2 on 2026-08-25 13:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.CharField(default='site', max_length=10)),
                ('question', models.TextField(blank=True, default='')),
                ('answer', models.TextField(blank=True, default='')),
                ('category', models.CharField(blank=True, default='', max_length=30)),
                ('specialist', models.CharField(blank=True, default='', max_length=60)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bot_logs', to=settings.AUTH_USER_MODEL)),
            ],
            options={
