...
////////////////////////////////////
СОХРАНЕНИЕ БЕЗ ФОРМАТИРОВАНИЯ комбинацией — через палитру команд:

Ctrl + Shift + P
в строке введите save without
выберите File: Save Without Formatting

***********************************
зайти в экран преподавателя, проверить входящие диагностики 
http://127.0.0.1:8000/staff/diagnostics/
